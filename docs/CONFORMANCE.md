...
storage-state save/load events. CDP websocket closure records a browser-stopped
...
navigation failures, origin localStorage/sessionStorage restore, and a full
